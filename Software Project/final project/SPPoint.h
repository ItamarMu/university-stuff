...
/**
 * Deallocates a 2D Point array using "free" function.
 *
 * @param mat Target 2D Point array to be deallocated. If it is NULL nothing will be done
 * @param rows number of rows in the 2D array
 * @param pointInRow number of points in each row
 */
void spPointDestroy2DPointArray(SPPoint** mat, int rows, int* pointInRow);
