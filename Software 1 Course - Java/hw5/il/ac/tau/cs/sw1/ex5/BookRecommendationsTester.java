...
public class BookRecommendationsTester {
	public static String USERS_CSV_FILE = "C:/Users/Dell/Desktop/ex5_files/BX-Users.csv"; // edit with the correct directories on your computer
	public static String BOOKS_CSV_FILE = "C:/Users/Dell/Desktop/ex5_files/BX-Books.csv"; // edit with the correct directories on your computer
	public static String RATINGS_CSV_FILE = "C:/Users/Dell/Desktop/ex5_files/BX-Ratings.csv"; // edit with the correct directories on your computer
	...
	public static void main(String[] args) throws Exception{
		...
		if (bR.getAverageRatingForBookInAgeGroup(7438, ageGroup) != 9.75){
			...
			System.out.println("ERROR 9"+bR.getAverageRatingForBookInAgeGroup(7438, ageGroup));
		}
